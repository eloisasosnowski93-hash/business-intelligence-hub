          ...
          <div className="px-4 pb-3">
            <div className="flex gap-1 bg-sidebar-accent rounded-lg p-1">
              <button onClick={() => setUnit("lab")}
                className={`flex-1 text-xs font-medium py-1.5 px-2 rounded-md transition-all flex items-center justify-center gap-1.5 ${unit === "lab" ? "bg-primary text-primary-foreground shadow-sm" : "text-sidebar-foreground/60 hover:text-sidebar-foreground"}`}>
                <Beaker className="h-3 w-3" /> Lab
              </button>
              <button onClick={() => setUnit("ocp")}
                className={`flex-1 text-xs font-medium py-1.5 px-2 rounded-md transition-all flex items-center justify-center gap-1.5 ${unit === "ocp" ? "bg-primary text-primary-foreground shadow-sm" : "text-sidebar-foreground/60 hover:text-sidebar-foreground"}`}>
