...
import { Upload, Loader2, FileText, Search, Download } from "lucide-react";
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="bento-card">
        ...
        <p className="text-xs text-muted-foreground mb-3">
          Colunas reconhecidas: empresa, contato_nome, email, telefone, etapa, status, responsavel, produtos, categoria. Separador vírgula ou ponto-e-vírgula.
        </p>
        <div className="flex gap-3 flex-wrap">
          <input
            ...
            className="flex-1 min-w-[200px] text-sm border border-input rounded-md px-3 py-2 cursor-pointer"
          />
        ...
        {preview && (
          <div className="mt-4 overflow-x-auto rounded border text-xs">
                ...
                {filtered.slice(0, 100).map((l) => (
                  <TableRow key={l.id} className="hover:bg-muted/50">
                    <TableCell>
                      ...
                      {l.produtos && (
                        <p className="text-[10px] text-muted-foreground truncate max-w-[180px]">{l.produtos}</p>
                      )}
                    </TableCell>
                    ...
                    <TableCell className="text-sm text-muted-foreground">
                      {l.responsavel_csv || l.responsavel || "—"}
                    </TableCell>
                    <TableCell>
